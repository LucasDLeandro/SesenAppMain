...
from .views import conf_whats_notif_view, configuracao_geral_view, logs_view, configuracao_telefonia_view, configuracao_tutorial_view, configuracao_acessos_view
