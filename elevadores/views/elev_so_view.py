...
from ..serializers import ElevConcluirOsSerializer, ElevRegistrarOsSerializer
...
class ElevadorViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        serializer = ElevRegistrarOsSerializer(request)
    ...
    def elev_concluir_os(self, request, pk=None):
        ...
        self._comunicar_conclusao_os(os_salva)
    ...
    def _comunicar_conclusao_os(self, os):
